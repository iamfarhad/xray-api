...
class TransportConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.xray.transport.internet.TransportProtocol protocol = 1 [deprecated = true];</code>
     * @deprecated
     */
    ...
    {
        @trigger_error('protocol is deprecated.', E_USER_DEPRECATED);
        GPBUtil::checkEnum($var, \Xray\Transport\Internet\TransportProtocol::class);
        $this->protocol = $var;
