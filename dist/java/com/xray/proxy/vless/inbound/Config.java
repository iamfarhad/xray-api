...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.xray.proxy.vless.inbound.ConfigOuterClass.internal_static_xray_proxy_vless_inbound_Config_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.xray.proxy.vless.inbound.ConfigOuterClass.internal_static_xray_proxy_vless_inbound_Config_fieldAccessorTable
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.xray.proxy.vless.inbound.Config)) {
      return super.equals(obj);
    }
    com.xray.proxy.vless.inbound.Config other = (com.xray.proxy.vless.inbound.Config) obj;
  ...
  public static com.xray.proxy.vless.inbound.Config parseFrom(
  ...
  public static com.xray.proxy.vless.inbound.Config parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.xray.proxy.vless.inbound.Config parseFrom(
  ...
  public static com.xray.proxy.vless.inbound.Config parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.xray.proxy.vless.inbound.Config parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static com.xray.proxy.vless.inbound.Config parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.xray.proxy.vless.inbound.Config prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:xray.proxy.vless.inbound.Config)
      com.xray.proxy.vless.inbound.ConfigOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.xray.proxy.vless.inbound.ConfigOuterClass.internal_static_xray_proxy_vless_inbound_Config_descriptor;
    }
    ...
    @java.lang.Override
    public com.xray.proxy.vless.inbound.Config getDefaultInstanceForType() {
      return com.xray.proxy.vless.inbound.Config.getDefaultInstance();
    }

    @java.lang.Override
    public com.xray.proxy.vless.inbound.Config build() {
      com.xray.proxy.vless.inbound.Config result = buildPartial();
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.xray.proxy.vless.inbound.Config) {
        return mergeFrom((com.xray.proxy.vless.inbound.Config)other);
      } else {
    ...
    public Builder mergeFrom(com.xray.proxy.vless.inbound.Config other) {
      if (other == com.xray.proxy.vless.inbound.Config.getDefaultInstance()) return this;
      if (clientsBuilder_ == null) {
    ...
    private void ensureClientsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        clients_ = new java.util.ArrayList<com.xray.common.protocol.User>(clients_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.xray.common.protocol.User, com.xray.common.protocol.User.Builder, com.xray.common.protocol.UserOrBuilder> clientsBuilder_;
     ...
     * <code>repeated .xray.common.protocol.User clients = 1;</code>
     */
    public Builder addClients(com.xray.common.protocol.User value) {
      if (clientsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>repeated .xray.common.protocol.User clients = 1;</code>
     */
    public com.xray.common.protocol.User.Builder getClientsBuilder(
        int index) {
     ...
     * <code>repeated .xray.common.protocol.User clients = 1;</code>
     */
    public com.xray.common.protocol.User.Builder addClientsBuilder() {
  ...
  checkByteStringIsUtf8(value);
    ...
    private void ensureFallbacksIsMutable() {
      if (!((bitField0_ & 0x00000002) != 0)) {
        fallbacks_ = new java.util.ArrayList<com.xray.proxy.vless.inbound.Fallback>(fallbacks_);
        bitField0_ |= 0x00000002;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.xray.proxy.vless.inbound.Fallback, com.xray.proxy.vless.inbound.Fallback.Builder, com.xray.proxy.vless.inbound.FallbackOrBuilder> fallbacksBuilder_;
    ...
    public Builder setFallbacks(
        int index, com.xray.proxy.vless.inbound.Fallback value) {
      if (fallbacksBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setFallbacks(
        int index, com.xray.proxy.vless.inbound.Fallback.Builder builderForValue) {
      if (fallbacksBuilder_ == null) {
        ensureFallbacksIsMutable();
     ...
     * <code>repeated .xray.proxy.vless.inbound.Fallback fallbacks = 3;</code>
     */
    public Builder addFallbacks(com.xray.proxy.vless.inbound.Fallback value) {
      if (fallbacksBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addFallbacks(
        com.xray.proxy.vless.inbound.Fallback.Builder builderForValue) {
      if (fallbacksBuilder_ == null) {
        ensureFallbacksIsMutable();
    ...
    public Builder addAllFallbacks(
        java.lang.Iterable<? extends com.xray.proxy.vless.inbound.Fallback> values) {
      if (fallbacksBuilder_ == null) {
        ensureFallbacksIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, fallbacks_);
     ...
     * <code>repeated .xray.proxy.vless.inbound.Fallback fallbacks = 3;</code>
     */
    public com.xray.proxy.vless.inbound.Fallback.Builder getFallbacksBuilder(
        int index) {
     ...
     * <code>repeated .xray.proxy.vless.inbound.Fallback fallbacks = 3;</code>
     */
    public com.xray.proxy.vless.inbound.Fallback.Builder addFallbacksBuilder() {
      return getFallbacksFieldBuilder().addBuilder(
          com.xray.proxy.vless.inbound.Fallback.getDefaultInstance());
    }
    /**
     * <code>repeated .xray.proxy.vless.inbound.Fallback fallbacks = 3;</code>
     */
    public com.xray.proxy.vless.inbound.Fallback.Builder addFallbacksBuilder(
        int index) {
      return getFallbacksFieldBuilder().addBuilder(
          index, com.xray.proxy.vless.inbound.Fallback.getDefaultInstance());
    }
    /**
     * <code>repeated .xray.proxy.vless.inbound.Fallback fallbacks = 3;</code>
     */
    public java.util.List<com.xray.proxy.vless.inbound.Fallback.Builder> 
         getFallbacksBuilderList() {
      return getFallbacksFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.xray.proxy.vless.inbound.Fallback, com.xray.proxy.vless.inbound.Fallback.Builder, com.xray.proxy.vless.inbound.FallbackOrBuilder> 
        getFallbacksFieldBuilder() {
      if (fallbacksBuilder_ == null) {
    ...
    // @@protoc_insertion_point(builder_scope:xray.proxy.vless.inbound.Config)
  }

  // @@protoc_insertion_point(class_scope:xray.proxy.vless.inbound.Config)
  private static final com.xray.proxy.vless.inbound.Config DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.xray.proxy.vless.inbound.Config();
  }

  public static com.xray.proxy.vless.inbound.Config getDefaultInstance() {
