...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 18: {
            if (!((mutable_bitField0_ & 0x00000002) != 0)) {
              header_ = new java.util.ArrayList<com.xray.proxy.http.Header>();
              mutable_bitField0_ |= 0x00000002;
            }
            header_.add(
                input.readMessage(com.xray.proxy.http.Header.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.xray.proxy.http.Config.internal_static_xray_proxy_http_ClientConfig_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.xray.proxy.http.Config.internal_static_xray_proxy_http_ClientConfig_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.xray.proxy.http.ClientConfig.class, com.xray.proxy.http.ClientConfig.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.xray.proxy.http.ClientConfig)) {
      return super.equals(obj);
    }
    com.xray.proxy.http.ClientConfig other = (com.xray.proxy.http.ClientConfig) obj;
  ...
  public static com.xray.proxy.http.ClientConfig parseFrom(
  ...
  public static com.xray.proxy.http.ClientConfig parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.xray.proxy.http.ClientConfig parseFrom(
  ...
  public static com.xray.proxy.http.ClientConfig parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.xray.proxy.http.ClientConfig parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static com.xray.proxy.http.ClientConfig parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.xray.proxy.http.ClientConfig prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:xray.proxy.http.ClientConfig)
      com.xray.proxy.http.ClientConfigOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.xray.proxy.http.Config.internal_static_xray_proxy_http_ClientConfig_descriptor;
    }
    ...
    @java.lang.Override
    public com.xray.proxy.http.ClientConfig getDefaultInstanceForType() {
      return com.xray.proxy.http.ClientConfig.getDefaultInstance();
    }

    @java.lang.Override
    public com.xray.proxy.http.ClientConfig build() {
      com.xray.proxy.http.ClientConfig result = buildPartial();
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.xray.proxy.http.ClientConfig) {
        return mergeFrom((com.xray.proxy.http.ClientConfig)other);
      } else {
    ...
    public Builder mergeFrom(com.xray.proxy.http.ClientConfig other) {
      if (other == com.xray.proxy.http.ClientConfig.getDefaultInstance()) return this;
      if (serverBuilder_ == null) {
    ...
    // @@protoc_insertion_point(builder_scope:xray.proxy.http.ClientConfig)
  }

  // @@protoc_insertion_point(class_scope:xray.proxy.http.ClientConfig)
  private static final com.xray.proxy.http.ClientConfig DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.xray.proxy.http.ClientConfig();
  }

  public static com.xray.proxy.http.ClientConfig getDefaultInstance() {
