...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.xray.app.router.ConfigOuterClass.internal_static_xray_app_router_Config_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.xray.app.router.ConfigOuterClass.internal_static_xray_app_router_Config_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.xray.app.router.Config.class, com.xray.app.router.Config.Builder.class);
  }

  /**
   * Protobuf enum {@code xray.app.router.Config.DomainStrategy}
   */
  public enum DomainStrategy
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return com.xray.app.router.Config.getDescriptor().getEnumTypes().get(0);
    }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (domainStrategy_ != com.xray.app.router.Config.DomainStrategy.AsIs.getNumber()) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.xray.app.router.Config)) {
      return super.equals(obj);
    }
    com.xray.app.router.Config other = (com.xray.app.router.Config) obj;
  ...
  public static com.xray.app.router.Config parseFrom(
  ...
  public static com.xray.app.router.Config parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.xray.app.router.Config parseFrom(
  ...
  public static com.xray.app.router.Config parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.xray.app.router.Config parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static com.xray.app.router.Config parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.xray.app.router.Config prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:xray.app.router.Config)
      com.xray.app.router.ConfigOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.xray.app.router.ConfigOuterClass.internal_static_xray_app_router_Config_descriptor;
    }
    ...
    @java.lang.Override
    public com.xray.app.router.Config getDefaultInstanceForType() {
      return com.xray.app.router.Config.getDefaultInstance();
    }

    @java.lang.Override
    public com.xray.app.router.Config build() {
      com.xray.app.router.Config result = buildPartial();
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.xray.app.router.Config) {
        return mergeFrom((com.xray.app.router.Config)other);
      } else {
    ...
    public Builder mergeFrom(com.xray.app.router.Config other) {
      if (other == com.xray.app.router.Config.getDefaultInstance()) return this;
    ...
    private void ensureRuleIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        rule_ = new java.util.ArrayList<com.xray.app.router.RoutingRule>(rule_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.xray.app.router.RoutingRule, com.xray.app.router.RoutingRule.Builder, com.xray.app.router.RoutingRuleOrBuilder> ruleBuilder_;
    ...
    public Builder setRule(
        int index, com.xray.app.router.RoutingRule value) {
      if (ruleBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setRule(
        int index, com.xray.app.router.RoutingRule.Builder builderForValue) {
      if (ruleBuilder_ == null) {
        ensureRuleIsMutable();
     ...
     * <code>repeated .xray.app.router.RoutingRule rule = 2;</code>
     */
    public Builder addRule(com.xray.app.router.RoutingRule value) {
      if (ruleBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addRule(
        com.xray.app.router.RoutingRule.Builder builderForValue) {
      if (ruleBuilder_ == null) {
        ensureRuleIsMutable();
    ...
    public Builder addAllRule(
        java.lang.Iterable<? extends com.xray.app.router.RoutingRule> values) {
      if (ruleBuilder_ == null) {
        ensureRuleIsMutable();
     ...
     * <code>repeated .xray.app.router.RoutingRule rule = 2;</code>
     */
    public com.xray.app.router.RoutingRule.Builder getRuleBuilder(
        int index) {
     ...
     * <code>repeated .xray.app.router.RoutingRule rule = 2;</code>
     */
    public com.xray.app.router.RoutingRule.Builder addRuleBuilder() {
      return getRuleFieldBuilder().addBuilder(
          com.xray.app.router.RoutingRule.getDefaultInstance());
    }
    /**
     * <code>repeated .xray.app.router.RoutingRule rule = 2;</code>
     */
    public com.xray.app.router.RoutingRule.Builder addRuleBuilder(
        int index) {
      return getRuleFieldBuilder().addBuilder(
          index, com.xray.app.router.RoutingRule.getDefaultInstance());
    }
    /**
     * <code>repeated .xray.app.router.RoutingRule rule = 2;</code>
     */
    public java.util.List<com.xray.app.router.RoutingRule.Builder> 
         getRuleBuilderList() {
      return getRuleFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.xray.app.router.RoutingRule, com.xray.app.router.RoutingRule.Builder, com.xray.app.router.RoutingRuleOrBuilder> 
        getRuleFieldBuilder() {
      if (ruleBuilder_ == null) {
    ...
    private void ensureBalancingRuleIsMutable() {
      if (!((bitField0_ & 0x00000002) != 0)) {
        balancingRule_ = new java.util.ArrayList<com.xray.app.router.BalancingRule>(balancingRule_);
        bitField0_ |= 0x00000002;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.xray.app.router.BalancingRule, com.xray.app.router.BalancingRule.Builder, com.xray.app.router.BalancingRuleOrBuilder> balancingRuleBuilder_;
    ...
    public Builder setBalancingRule(
        int index, com.xray.app.router.BalancingRule value) {
      if (balancingRuleBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setBalancingRule(
        int index, com.xray.app.router.BalancingRule.Builder builderForValue) {
      if (balancingRuleBuilder_ == null) {
        ensureBalancingRuleIsMutable();
     ...
     * <code>repeated .xray.app.router.BalancingRule balancing_rule = 3;</code>
     */
    public Builder addBalancingRule(com.xray.app.router.BalancingRule value) {
      if (balancingRuleBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addBalancingRule(
        com.xray.app.router.BalancingRule.Builder builderForValue) {
      if (balancingRuleBuilder_ == null) {
        ensureBalancingRuleIsMutable();
    ...
    public Builder addAllBalancingRule(
        java.lang.Iterable<? extends com.xray.app.router.BalancingRule> values) {
      if (balancingRuleBuilder_ == null) {
        ensureBalancingRuleIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
     ...
     * <code>repeated .xray.app.router.BalancingRule balancing_rule = 3;</code>
     */
    public com.xray.app.router.BalancingRule.Builder getBalancingRuleBuilder(
        int index) {
     ...
     * <code>repeated .xray.app.router.BalancingRule balancing_rule = 3;</code>
     */
    public com.xray.app.router.BalancingRule.Builder addBalancingRuleBuilder() {
      return getBalancingRuleFieldBuilder().addBuilder(
          com.xray.app.router.BalancingRule.getDefaultInstance());
    }
    /**
     * <code>repeated .xray.app.router.BalancingRule balancing_rule = 3;</code>
     */
    public com.xray.app.router.BalancingRule.Builder addBalancingRuleBuilder(
        int index) {
      return getBalancingRuleFieldBuilder().addBuilder(
          index, com.xray.app.router.BalancingRule.getDefaultInstance());
    }
    /**
     * <code>repeated .xray.app.router.BalancingRule balancing_rule = 3;</code>
     */
    public java.util.List<com.xray.app.router.BalancingRule.Builder> 
         getBalancingRuleBuilderList() {
      return getBalancingRuleFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.xray.app.router.BalancingRule, com.xray.app.router.BalancingRule.Builder, com.xray.app.router.BalancingRuleOrBuilder> 
        getBalancingRuleFieldBuilder() {
      if (balancingRuleBuilder_ == null) {
    ...
    // @@protoc_insertion_point(builder_scope:xray.app.router.Config)
  }

  // @@protoc_insertion_point(class_scope:xray.app.router.Config)
  private static final com.xray.app.router.Config DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.xray.app.router.Config();
  }

  public static com.xray.app.router.Config getDefaultInstance() {
