...
public interface ConfigOrBuilder extends
   ...
   */
  @java.lang.Deprecated java.util.List<com.xray.common.net.Endpoint> 
      getNameServersList();
  /**
   * <pre>
   * Nameservers used by this DNS. Only traditional UDP servers are support at
   ...
   * <code>repeated .xray.common.net.Endpoint NameServers = 1 [deprecated = true];</code>
   */
  @java.lang.Deprecated com.xray.common.net.Endpoint getNameServers(int index);
  /**
   * <pre>
   * Nameservers used by this DNS. Only traditional UDP servers are support at
   * the moment. A special value 'localhost' as a domain address can be set to
   ...
   * <code>repeated .xray.common.net.Endpoint NameServers = 1 [deprecated = true];</code>
   */
  @java.lang.Deprecated java.util.List<? extends com.xray.common.net.EndpointOrBuilder> 
   ...
   * <code>repeated .xray.common.net.Endpoint NameServers = 1 [deprecated = true];</code>
   */
  @java.lang.Deprecated com.xray.common.net.EndpointOrBuilder getNameServersOrBuilder(
      int index);
   ...
   */
  java.util.List<com.xray.app.dns.NameServer> 
      getNameServerList();
  /**
   * <pre>
   * NameServer list used by this DNS client.
   ...
   * <code>repeated .xray.app.dns.NameServer name_server = 5;</code>
   */
  com.xray.app.dns.NameServer getNameServer(int index);
  /**
   * <pre>
   * NameServer list used by this DNS client.
   * </pre>
   ...
   * <code>repeated .xray.app.dns.NameServer name_server = 5;</code>
   */
  java.util.List<? extends com.xray.app.dns.NameServerOrBuilder> 
   ...
   * <code>repeated .xray.app.dns.NameServer name_server = 5;</code>
   */
  com.xray.app.dns.NameServerOrBuilder getNameServerOrBuilder(
      int index);
  ...
  java.util.Map<java.lang.String, com.xray.common.net.IPOrDomain>
  getHosts();
  /**
   * <pre>
   * Static hosts. Domain to IP.
   ...
   * <code>map&lt;string, .xray.common.net.IPOrDomain&gt; Hosts = 2 [deprecated = true];</code>
   */
  @java.lang.Deprecated java.util.Map<java.lang.String, com.xray.common.net.IPOrDomain>
  getHostsMap();
  /**
   * <pre>
   * Static hosts. Domain to IP.
   ...
   */
  java.util.List<com.xray.app.dns.Config.HostMapping> 
      getStaticHostsList();
  /**
   * <code>repeated .xray.app.dns.Config.HostMapping static_hosts = 4;</code>
   */
  com.xray.app.dns.Config.HostMapping getStaticHosts(int index);
  /**
   * <code>repeated .xray.app.dns.Config.HostMapping static_hosts = 4;</code>
   */
   ...
   * <code>repeated .xray.app.dns.Config.HostMapping static_hosts = 4;</code>
   */
  java.util.List<? extends com.xray.app.dns.Config.HostMappingOrBuilder> 
      getStaticHostsOrBuilderList();
  /**
   * <code>repeated .xray.app.dns.Config.HostMapping static_hosts = 4;</code>
   */
  com.xray.app.dns.Config.HostMappingOrBuilder getStaticHostsOrBuilder(
      int index);
