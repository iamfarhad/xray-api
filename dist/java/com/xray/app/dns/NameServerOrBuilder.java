...
public interface NameServerOrBuilder extends
   ...
   */
  java.util.List<com.xray.app.dns.NameServer.PriorityDomain> 
      getPrioritizedDomainList();
  /**
   * <code>repeated .xray.app.dns.NameServer.PriorityDomain prioritized_domain = 2;</code>
   */
  com.xray.app.dns.NameServer.PriorityDomain getPrioritizedDomain(int index);
  /**
   * <code>repeated .xray.app.dns.NameServer.PriorityDomain prioritized_domain = 2;</code>
   */
   ...
   * <code>repeated .xray.app.dns.NameServer.PriorityDomain prioritized_domain = 2;</code>
   */
  java.util.List<? extends com.xray.app.dns.NameServer.PriorityDomainOrBuilder> 
      getPrioritizedDomainOrBuilderList();
  /**
   * <code>repeated .xray.app.dns.NameServer.PriorityDomain prioritized_domain = 2;</code>
   */
  com.xray.app.dns.NameServer.PriorityDomainOrBuilder getPrioritizedDomainOrBuilder(
      int index);
   ...
   */
  java.util.List<com.xray.app.dns.NameServer.OriginalRule> 
      getOriginalRulesList();
  /**
   * <code>repeated .xray.app.dns.NameServer.OriginalRule original_rules = 4;</code>
   */
  com.xray.app.dns.NameServer.OriginalRule getOriginalRules(int index);
  /**
   * <code>repeated .xray.app.dns.NameServer.OriginalRule original_rules = 4;</code>
   */
   ...
   * <code>repeated .xray.app.dns.NameServer.OriginalRule original_rules = 4;</code>
   */
  java.util.List<? extends com.xray.app.dns.NameServer.OriginalRuleOrBuilder> 
